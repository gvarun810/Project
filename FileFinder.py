...
Rape = ('Child abuse','Domestic violence','Blackmail','Guilt','Sex','Murder','Victim','Fear','Gang Rape','Rod','Vagina','Condoms')
Murder = ('Arson','Hit and run','Homicide','Poaching','Genocide','Assassination','Felony','Manslaughter','Bloodshed','Guns','Pistols','Rifle','Knife','Hammer','Strangulation')
Terrorism = ('Bombing','Espionage','Dynamite','Conflict','Hijacking','Kidnapping','Cyber terrorism','Explosive','Explosion')
paths = ('C:','D:')
